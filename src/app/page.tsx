...
export default function Home() {
  ...
  return (
    <><header className="text-center py-20 bg-base-200 border md:flex-row overflow-x-auto min-w-screen-md" >
      <h1 className="text-2xl font-bold mb-4 drop-shadow-2xl">
        <span>Universitatea din Craiova</span>
      </h1>
      <h1 className="text-xl font-bold mb-4 drop-shadow-2xl">
        <span>Facultatea de Automatică, Calculatoare și Electronică</span>
      </h1>
    </header>
    <div className="min-h-screen flex flex-col md:flex-row bg-base-300 overflow-x-auto border">
